...
function sendEmail() {
  const bodyMessage = `Full Name: ${name.value}<br> Email ID: ${email.value}<br> Phone Number: ${phone.value}<br> Subject: ${subject.value}<br> Message: ${message.value}<br>`;
  Email.send({
    SecureToken :"f64e3e82-e009-4584-84ab-65c96c019650",
    To: 'bhavikahir96247@gmail.com',
    From: "bhavikahir96247@gmail.com",
